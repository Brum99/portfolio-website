...
<div className="flex flex-col md:flex-row justify-center gap-6 mt-8 mb-10">
  <div className="flex-1 text-center">
    ...
    />
    <p className="mt-3 text-sm text-gray-700 dark:text-gray-300">Training Set Distribution</p>
  </div>
  ...
  <div className="flex-1 text-center">
    <img 
      ...
      className="rounded-lg shadow-md w-full max-w-[400px] mx-auto"
    />
    <p className="mt-3 text-sm text-gray-700 dark:text-gray-300">Test Set Distribution</p>
  </div>
</div>
